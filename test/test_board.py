...
class TestBoard(unittest.TestCase):
    def test_determine_is_full_returns_true_if_board_is_full(self):
        board = Board()
        full_board = ["X", "O", "X", "O", "X", "O", "X", "O", "X"]
        total_marks_on_board = board.count_marks(full_board)
        self.assertEqual(
            True, board.determine_is_full(total_marks_on_board, full_board)
        )

    def test_determine_is_full_returns_false_if_board_isnt_full(self):
        board = Board()
        full_board = ["X", "2", "3", "4", "X", "O", "X", "O", "X"]
        total_marks_on_board = board.count_marks(full_board)
        self.assertEqual(
            False, board.determine_is_full(total_marks_on_board, full_board)
        )
    ...
    def test_determine_is_spot_taken_returns_true_when_spot_is_marked(self):
        board = Board()
        current_board = ["X", "2", "3", "4", "5", "6", "7", "8", "9"]
        user_input = 1
    ...
    def test_determine_is_spot_taken_returns_true_when_spot_is_marked_2(self):
        board = Board()
    ...
    def test_determine_is_spot_taken_returns_false_with_multiple_spots_taken(self):
        board = Board()
    ...
    def test_determine_is_spot_taken_returns_false_if_spot_is_avail(self):
        board = Board()
        current_board = ["1", "2", "3", "4", "5", "6", "7", "8", "9"]
        user_input = 2
        spot_is_taken = board.determine_is_spot_taken(current_board, user_input)
    ...
    def test_determine_is_spot_taken_returns_false_with_multiple_spots_taken_2(self):
        board = Board()
